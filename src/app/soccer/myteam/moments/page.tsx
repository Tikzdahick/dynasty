...
import {
  ...
  LiveMoment,
  UpcomingMoment,
} from "@/lib/soccer-myteam/moments";
import { getCoins, getOwned, spendCoins, addOwned } from "@/lib/store/soccer/myteam";
...
export default function MomentsPage() {
  ...
  const claim = async () => {
    ...
    if (user) {
      const res = await grantRequest({ type: "moment", sport: "soccer", cardId: live.card.id });
      if (res.error) {
        flash(
