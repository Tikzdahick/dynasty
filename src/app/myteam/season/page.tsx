...
export default function SeasonPassPage() {
  ...
  return (
    <div className="bg-grain">
      ...
      {toast && (
        <div className="fixed left-1/2 top-16 z-50 -translate-x-1/2 rounded-xl border border-amber-300/40 bg-ink/95 px-4 py-2 text-sm font-semibold text-amber-200 shadow-lg">
          {toast}
        </div>
      )}
      ...
      <div className="mb-5">
        ...
        <p className="text-sm text-white/50">
          Earn XP from games, packs, and challenges to unlock the track.
        </p>
      </div>
      ...
      <div className="card mb-6 p-5">
        <div className="flex items-end justify-between">
          <div>
            ...
            <div className="text-3xl font-black text-amber-300">{tier}/12</div>
          </div>
          ...
          return (
            <motion.button
              ...
              className={`relative flex w-28 shrink-0 flex-col items-center rounded-2xl border p-3 text-center transition ${
                isClaimable
                  ? "border-amber-300 bg-amber-400/15 shadow-[0_0_26px_-6px_rgba(251,191,36,0.7)]"
                  : isClaimed
            ...
            >
              ...
              {isClaimable && (
                <span className="absolute -top-2 rounded-full bg-amber-400 px-2 text-[9px] font-black text-black">
                  CLAIM
                </span>
              )}
            </motion.button>
