...
import { TEAMS, teamById } from "@/lib/soccer-myteam/teams";
import { TeamBadge } from "@/components/soccer-myteam/TeamBadge";
      ...
      <div className="mx-auto flex w-full max-w-4xl flex-1 flex-col overflow-y-auto p-6">
        ...
        >
          ...
          <p className="mx-auto mt-2 max-w-md text-sm text-white/55">
            Choose your club or nation to claim a free Starter Pack of players to build from.
          </p>
        </motion.div>
          ...
          >
            <div className="mx-auto flex max-w-4xl items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-white/45">Your side</div>
