...
import { Card, RARITY_ORDER, tierForCard } from "@/lib/soccer-myteam/cards";
    ...
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/85 p-6 backdrop-blur-md">
      {!done ? (
        ...
        >
          ...
          <button onClick={onDone} className="btn mt-6 w-full bg-soccer text-black hover:bg-soccer-gold">
