...
const INIT_KEY = "dynasty.myteam.init";
const LINEUP_KEY = "dynasty.myteam.lineup";
const ONBOARD_KEY = "dynasty.myteam.onboarded";
const TEAM_KEY = "dynasty.myteam.favteam";

export const STARTING_COINS = 2500;

export interface OwnedCard {
  iid: string; // unique instance id (duplicates are distinct, for selling/auctions later)
  cardId: string;
  acquiredAt: number;
}
