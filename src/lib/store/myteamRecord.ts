// MyTeam win/loss record — drives the MyTeam leaderboard ranking. Grows as the
// user plays exhibition games with their built lineup.
const KEY = "dynasty.myteam.record";
