// Soccer player upgrades — spend coins to raise a Bronze/Silver card's stats a
// little. Stored per card id (all copies share the upgrade level). Effective
// stats are resolved via applyUpgrade so upgrades show everywhere the card
// appears.
import { Card, cardById, applyUpgrade } from "@/lib/soccer-myteam/cards";

const KEY = "dynasty.sc.upgrades";
