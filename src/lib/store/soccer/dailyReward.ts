// Soccer daily login-reward streak. Tracks consecutive days the user has
// *claimed* a reward in the soccer MyTeam economy.
const KEY = "dynasty.sc.dailyreward";
...
export interface DailyStatus {
  ...
  pendingDay: number; // 1..CYCLE_LENGTH
}
