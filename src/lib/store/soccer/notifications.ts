// Soccer in-app notifications feed (auction sales/outbids, moment drops, daily
// ready, rival challenges). Namespaced separately from the NBA feed.
const KEY = "dynasty.sc.notifications";
const MAX = 60;
