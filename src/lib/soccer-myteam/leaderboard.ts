// Soccer MyTeam leaderboard — ranks the local user against a roster of bot
// rivals. Bot rivals are generated deterministically so the board is stable; the
// user's row updates live as they play.
import { mulberry32, seedFromString } from "@/lib/rng";
import { CARD_POOL, Card } from "@/lib/soccer-myteam/cards";
...
const BOT_NAMES = [
  "GegenpressGus", "TikiTaka", "BoxToBox", "TheGaffer", "OffsideTrap",
  "ParkTheBus", "Catenaccio", "FalseNine", "CornerTaken", "WingBackWiz",
  "ChampoMan", "TouchlineTom", "MidfieldMaestro", "DerbyDay", "PoacherPete",
  "TotalFootball", "SetPieceSam", "NutmegNed", "CleanSheet", "ExtraTime",
  "TheTreble", "RabonaRudy", "LongBallLou", "PressResist", "TheVolley",
  "GoldenBoot", "HatTrickHal", "ScreamerSid", "TheLibero", "FinalThird",
];
...
export function botRivals(): RivalBase[] {
  const rng = mulberry32(seedFromString("dynasty:soccer:myteam:leaderboard:v1"));
