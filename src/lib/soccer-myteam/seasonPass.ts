// Soccer Season Pass — a 6-week XP progression track. XP comes from playing
...
export const SEASON_TIERS: SeasonTier[] = [
  ...
  { tier: 10, xp: 5700, reward: { kind: "pack", packId: "dynasty", emoji: "💎", label: "Icon Pack" } },
  { tier: 11, xp: 6600, reward: { kind: "coins", amount: 2000, emoji: "🪙", label: "2,000 Coins" } },
  { tier: 12, xp: 7600, reward: { kind: "card", minRarity: "Dynasty", emoji: "🐐", label: "Icon Legend" }, exclusive: true },
];
