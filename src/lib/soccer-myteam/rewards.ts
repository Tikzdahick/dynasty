// Soccer MyTeam — the 7-day daily-reward ladder and the logic that materialises
// a reward into coins / cards. Rewards escalate across the cycle and reset to
// Day 1 after Day 7, while the login streak keeps climbing.
import { Card, Rarity } from "@/lib/soccer-myteam/cards";
import { openPack, packById, drawAtLeast } from "@/lib/soccer-myteam/packs";
import { addCoins, addOwned, getCoins } from "@/lib/store/soccer/myteam";
import { CYCLE_LENGTH } from "@/lib/store/soccer/dailyReward";
import { logPackOpen } from "@/lib/store/soccer/packHistory";
